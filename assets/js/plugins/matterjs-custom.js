function initSimulation() {
  ...
  var categories1 = Bodies.rectangle(containerWidth / 2 + 150, 500, 164, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/01.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories2 = Bodies.rectangle(containerWidth / 2 - 150, 460, 122, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/02.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories3 = Bodies.rectangle(containerWidth / 2 + 250, 420, 204, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/03.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories4 = Bodies.rectangle(containerWidth / 2 - 75, 380, 204, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/04.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories5 = Bodies.rectangle(containerWidth / 2 - 74, 540, 194, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/05.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories6 = Bodies.rectangle(containerWidth / 2 + 174, 490, 216, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/06.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories7 = Bodies.rectangle(containerWidth / 2 - 142, 440, 167, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/07.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories8 = Bodies.rectangle(containerWidth / 2 - 10, 260, 260, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/08.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories9 = Bodies.rectangle(containerWidth / 2 - 242, 420, 174, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/09.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories10 = Bodies.rectangle(containerWidth / 2 + 60, 300, 285, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/10.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories11 = Bodies.rectangle(containerWidth / 2, 320, 170, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/11.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories12 = Bodies.rectangle(containerWidth / 2 - 59, 260, 60, 56, {
    ...
    render: {
      sprite: {
        texture: "./assets/images/icon/12.png",
        xScale: 1,
        yScale: 1,
      },
    },
  ...
  var categories13 = Bodies.rectangle(containerWidth / 2 + 110, 260, 110, 56, {
    chamfer: { radius: radius },
    render: {
      sprite: {
        texture: "./assets/images/icon/13.png",
        xScale: 1,
        yScale: 1,
      },
    },
  });
  var categories14 = Bodies.rectangle(containerWidth / 2 - 110, 296, 201, 56, {
    chamfer: { radius: radius },
    render: {
      sprite: {
        texture: "./assets/images/icon/14.png",
        xScale: 1,
        yScale: 1,
      },
    },
  });
  var categories15 = Bodies.rectangle(containerWidth / 2 - 10, 260, 101, 56, {
    chamfer: { radius: radius },
    render: {
      sprite: {
        texture: "./assets/images/icon/15.png",
        xScale: 1,
        yScale: 1,
      },
    },
  });
  var categories16 = Bodies.rectangle(containerWidth / 2 - 80, 260, 201, 56, {
    chamfer: { radius: radius },
    render: {
      sprite: {
        texture: "./assets/images/icon/16.png",
        xScale: 1,
        yScale: 1,
      },
    },
  });
  var categories17 = Bodies.rectangle(containerWidth / 2 - 110, 260, 201, 56, {
    chamfer: { radius: radius },
    render: {
      sprite: {
        texture: "./assets/images/icon/17.png",
        xScale: 1,
        yScale: 1,
      },
    },
